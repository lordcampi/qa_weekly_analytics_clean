...
def test_agents_small_multiples_has_one_trace_per_agent() -> None:
    ...
    fig = agents_small_multiples(week_labels, series)
...
def test_agents_small_multiples_empty_returns_figure() -> None:
    fig = agents_small_multiples([], {})
